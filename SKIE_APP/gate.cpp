...
Lone_gate::Lone_gate( std::string name, Colour::Colour colour, float x, float y, bool x_coord_is_left_side )
...
Gate::Gate( std::string name, Colour::Colour colour, float x, float y, bool x_coord_is_left_side )
    : Moving_game_object( name ),

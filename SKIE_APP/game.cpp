    ...
    if( m_splash_screen == NULL ) {
        ...
        if( !m_done_start_splash ) {
            ...
            if( m_course_finished ) {
                m_splash_screen->Show( "/Users/korish/Desktop/SKIE-APP/SKIE_APP/SKIE_APP/images/race_finished.png" );
            } else {
                m_splash_screen->Show( "/Users/korish/Desktop/SKIE-APP/SKIE_APP/SKIE_APP/images/disqualified.png" );
            }
        }
    }
}

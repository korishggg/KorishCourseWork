...
Button::Button( Game * game, std::string name,sf::IntRect normal_rect, sf::IntRect hover_rect )
    : Visible_game_object( game, name ),
      m_normal_rect( normal_rect ),
      m_hover_rect( hover_rect ),
      m_is_hovering( false )
{
    Load( "/Users/korish/Desktop/SKIE-APP/SKIE_APP/SKIE_APP/images/menu_buttons.png" );
...
Menu::Menu( Game * game, std::string name )
    : Visible_game_object( game, name ),
      ...
      m_exit_button( NULL )
{    
    Load( "/Users/korish/Desktop/SKIE-APP/SKIE_APP/SKIE_APP/images/menu_background.png" );
